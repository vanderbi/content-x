...
![](../../static/images/event-sub-dropdown.png)

3. Complete the subscription form

![](../../static/images/event-sub-form.png)
...
![](../../static/images/event-sub-delete.png)
